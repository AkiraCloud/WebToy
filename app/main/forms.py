...
from wtforms import StringField, DateTimeField, DateField, SelectField, PasswordField, BooleanField, SubmitField
...
class TransInfoFrom(FlaskForm):
    ...
    infoContent = StringField('Content', validators=[input_required()])
